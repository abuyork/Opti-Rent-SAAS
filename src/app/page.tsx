 ...
 * Full SaaS layout per docs/design-ref.md: sticky nav, editorial hero with the
 * audit form, product preview, how-it-works, evidence split with a terminal
 * panel, pricing tiers, FAQ, footer. All market figures are computed from the
 * real scan data — never hardcoded.
 */
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: `We have run full market scans in ${marketList}. Listings elsewhere still get scored against their own comparable set; the winners section appears once we have scanned your market.`,
    },
    {
      ...
      <main id="top" className="mx-auto max-w-5xl px-6">
        ...
        <section className="mx-auto max-w-3xl pt-20 pb-16 text-center sm:pt-28">
          ...
          <p className="mx-auto mt-8 max-w-xl text-base leading-relaxed text-steel">
            Paste your Airbnb link. In about a minute you get a free listing
            score, an underpricing estimate against comparable villas, and a
            count of what needs fixing.
          </p>
        ...
        <section className="relative pb-24">
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-4 text-center font-mono text-[11px] uppercase tracking-wide text-pewter">
              A real winner from our Canggu scan, shown the way your report shows it
            </p>
          </div>
        </section>
          ...
          <div className="grid items-center gap-12 sm:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-base leading-relaxed text-steel">
                ...
                across <b className="font-medium text-ink">{marketList}</b>,
            ...
            {/* Terminal panel: real 2BR Canggu scan output */}
                  ...
                  <>
                    ...
                    <p className="text-fog">
                      ...
                      <span className="text-dove">
                        {bench.winner_median_photos} vs {bench.loser_median_photos}
                      </span>
                    </p>
                    <p className="text-fog">
                      {"  "}description{"   "}
