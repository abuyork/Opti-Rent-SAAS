...
export function getLandingScope(slug: LandingScope["slug"]): LandingScope {
  if (slug === "bali") {
    ...
    return {
      ...
      heroSub:
        "Paste your Airbnb link. In a minute or two you get a free listing score, an underpricing estimate against comparable villas in your region, and a count of what needs fixing.",
  ...
  if (slug === "dubai" || slug === "london") {
    ...
    return {
      ...
      heroSub: `Paste your Airbnb link. In a minute or two you get a free listing score, an underpricing estimate against comparable ${title} ${compNoun}, and a count of what needs fixing.`,
  ...
  return {
    ...
    heroHeadline: "Your Airbnb is leaving money on the table.",
    heroSub:
      "Paste your Airbnb link. In a minute or two you get a free listing score, an underpricing estimate against comparable listings in your market, and a count of what needs fixing.",
